...
import 'is_partnred_attending_widget.dart';
    ...
    return FutureBuilder(
      ...
      builder: (ctx, snapshot) => snapshot.connectionState ==
          ...
          : Consumer<EventProvider>(
              ...
              builder: (ctx, allEventsConsumer, ch) => allEventsConsumer
                          .allEvents.length <=
                      0
                  ? ch
                  : AnimationLimiter(
                        ...
                        itemBuilder: (ctx, i) =>
                          ...
                          child: SlideAnimation(
                            ...
                            child: FadeInAnimation(
                              child: allEventsConsumer
                                          .allEvents[i].isPartnered ==
                                      true
                                  ? IsPartneredAttendingWidget(
                                      allEvents: allEventsConsumer.allEvents[i],
                                    )
                                  : FriendAttendingWidget(
                                      allEvents: allEventsConsumer.allEvents[i],
                                    ),
                            ),
                          ),
